...
from .views import list_book, admin_view, librarian_view, member_view, add_book, edit_book, delete_book, book_list


urlpatterns = [
    path('list_book/', list_book.as_view(), name='list-book' ),
